...
vector<vector<long long int>> subtract(vector<vector<long long int>> v1, vector<vector<long long int>> v2){
    size_t n{v1.size()};
    for(size_t i{0}; i<n; i++){
        for(size_t j{0}; j<n; j++){
            v1[i][j]=v1[i][j]-v2[i][j];
...
vector<vector<long long int>> multiply(vector<vector<long long int>> v1, vector<vector<long long int>> v2){
    if(v1.size()==1){
        ...
        // vector<vector<long long int>> S1 = add(A11, A22);
        // vector<vector<long long int>> S2 = add(B11, B22);
        // vector<vector<long long int>> S3 = add(A21, A22);
        // vector<vector<long long int>> S4 = subtract(B12, B22);
        // vector<vector<long long int>> S5 = subtract(B21, B11);
        // vector<vector<long long int>> S6 = add(A11, A12);
        // vector<vector<long long int>> S7 = subtract(A21, A11);
        // vector<vector<long long int>> S8 = add(B11, B12);
        // vector<vector<long long int>> S9 = subtract(A12, A22);
        // vector<vector<long long int>> S10 = add(B21, B22);

        vector<vector<long long int>> p1 = multiply(add(A11, A22), add(B11, B22));
        vector<vector<long long int>> p2 = multiply(add(A21, A22), B11);
        vector<vector<long long int>> p3 = multiply(A11, subtract(B12, B22));
        vector<vector<long long int>> p4 = multiply(A22, subtract(B21, B11));
        vector<vector<long long int>> p5 = multiply(add(A11, A12), B22);
        vector<vector<long long int>> p6 = multiply(subtract(A21, A11), add(B11, B12));
        vector<vector<long long int>> p7 = multiply(subtract(A12, A22), add(B21, B22));

        vector<vector<long long int>> B = add(p3, p5);
        vector<vector<long long int>> C = add(p2, p4);
        vector<vector<long long int>> A = add(add(p1, p4), subtract(p7, p5));
        vector<vector<long long int>> D = add(add(p1, p3), subtract(p6, p2));
